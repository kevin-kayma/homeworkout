...
//
    ...
    fun prepareTabView(pos: Int): View? {
        ...
        view.findViewById<CTextView>(R.id.tvTabTitle).text = tabTitles[pos]
        view.findViewById<CTextView>(R.id.tvTabTitle).setOnClickListener {
            dialogExDetailBinding!!.pagerFragment.setCurrentItem(pos, true)
        }
        if (pos == 0) {
            view.findViewById<CTextView>(R.id.tvTabTitle).isSelected = true
        }
